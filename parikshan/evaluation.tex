...
%Finally, in Section~\ref{sec:survey}, we present a survey of 220 real-world bugs, picked from three different applications.
...
%Overall this suggests that state-of-art techniques in live migration are already robust enough to support very low downtime and no impact on user-experience, and this is likely to get better with future research.
...
%Previous academic work has clearly demonstrated that there is a correlation between the number of dirty pages and the live migration time, which can impact more stricter SLA guarantees.
