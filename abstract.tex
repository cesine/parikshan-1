...
In order to realize continuous delivery, modern-day SOA applications focus on frequent releases and require a short time to a bug fix, test, and patch (Facebook mobile has 2 releases a day, and Flickr has 10 deployment cycles per day).
